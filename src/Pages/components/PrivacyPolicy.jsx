...
import "../../CSS/ComponentsCSS/PrivacyPolicy.css";

const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy">
      <h1>Privacy Policy</h1>
      <p className="date">Last updated: March 05, 2024</p>
      ...
      <p>
        ...
        when this data is used to strengthen security or to improve the
