...
import '../../CSS/ComponentsCSS/TermsConditions.css';

const TermsConditions = () => {
  return (
    <div className="terms-container">
      <h1>Terms &amp; Conditions</h1>
      <p className="last-updated">Last updated: March 05, 2024</p>

      {/* ================= Terms-Section: Interpretation ================= */}
      <Terms-Section className="Terms-Section">
      ...
      <Terms-Section className="Terms-Section">
        ...
        <p>
          ...
          the Service or 100 USD if You haven&apos;t purchased anything through
          the Service.
        </p>
        <p>
      ...
      <Terms-Section className="Terms-Section">
        ...
        <p>
          ...
          set forth in this Terms-Section shall be applied to the greatest extent
          enforceable under applicable law.
        </p>
      </Terms-Section>

      {/* ================= Remaining Terms-Sections ================= */}
      <Terms-Section className="Terms-Section">
        <h2>Governing Law</h2>
        <p>
