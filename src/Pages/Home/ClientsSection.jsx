...
const ClientsSection = () => {
  ...
  const logos = [
    ...
    { src: "/images/Home/ClientLogos/Prince Pipe logo.png", alt: "Prince Pipes", className: "ss-clientLogo8" },
    { src: "/images/Home/ClientLogos/6.png", alt: "Saraswat Bank", className: "ss-clientLogo9" },
    ...
    { src: "/images/Home/ClientLogos/11.png", alt: "Gunnebo", className: "ss-clientLogo8" },
    { src: "/images/Home/ClientLogos/12.png", alt: "Hettich", className: "ss-clientLogo-hettich" },
    { src: "/images/Home/ClientLogos/Crisil.png", alt: "Crisil", className: "ss-clientLogo-crisil" },
